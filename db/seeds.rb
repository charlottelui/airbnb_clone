...
Item.create(title: 'Used water bottle', description: 'I do not where to go to recycle this bottle. I drank most of it but there are still a few sips left', price: 30, user: charlotte)
...
Item.create(title: 'Broken bag', description: 'The zipper is broken so it does not close and all of my things are always falling out. If you know how to sew you might be able to fix it.', price: 20, user: talia)
...
Item.create(title: 'New York Times 1997', description: 'I found this newspaper when I was doing some spring cleaning. this issue is a bit outdated but a still great read.', price: 100, user: angel)
Item.create(title: 'Used whiteboard', description: 'I wrote a bunch of stuff on the board and left it for a month. I am too lazy to buy whiteboard cleaner to erase it all. Comes with a free marker', price: 22, user: angel)
Item.create(title: 'Broken headphones', description: 'The left earbud does not work and I just bought new AirPods', price: 22, user: angel)
