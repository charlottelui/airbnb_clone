...
Item.create(title: 'Vintage watch (broken)', description: 'The watch is stuck and it always says that the time is 3 pm. It is a nice watch and I always get tons of compliments on it. It matches every outfit!', price: 20, user: talia, address:'Simtat Beit HaSho\'eva 12, Tel Aviv-Yafo, 6688119')
Item.create(title: 'Broken bag', description: 'The zipper is broken so it does not close and all of my things are always falling out. If you know how to sew you might be able to fix it.', price: 20, user: talia, address:'Lilienblum St 18, Tel Aviv-Yafo')
